...
import 'package:external_path_provider/src/external_path_provider_method_channel.dart';
...
void main() {
  final ExternalPathProviderPlatform initialPlatform =
      ExternalPathProviderPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockExternalPathProviderPlatform fakePlatform =
        MockExternalPathProviderPlatform();
